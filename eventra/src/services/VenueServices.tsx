...
const createVenueApi = async (
  venue: VenueType | FormData,
): Promise<ApiReturnType> => {
  ...
  try {
    ...
    return {
      data: null,
      message: 'Error in venues creating',
      success: false,
      error: JSON.stringify(error),
    }; // Rethrow the error to be handled by the calling function
  }
