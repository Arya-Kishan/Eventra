...
const createPostApi = async (post: FormData): Promise<ApiReturnType> => {
  ...
  try {
    ...
    return {
      data: null,
      message: 'Error in posts creating',
      success: false,
      error: JSON.stringify(error),
    }; // Rethrow the error to be handled by the calling function
  }
...
const getCommentsOfSinglePostApi = async (
  postId: string,
): Promise<ApiReturnType> => {
  try {
    ...
    return {
      data: null,
      message: 'Error in post comment fetching',
      success: false,
      error: JSON.stringify(error),
    }; // Rethrow the error to be handled by the calling function
  }
...
const createCommentPostApi = async (
