...
const CartScreen = () => {
  ...
  const PlaceOrder = async () => {
    const newProducts: ProductOrderType[] = cartDetail?.map(item => ({
    ...
    success
      ? clearCart()
      : showToast({title: 'Order Placed', description: '', type: 'success'});
  };
  ...
  return (
    <View style={{flex: 1}}>
      <View style={styles.header}>
        ...
        <CustomText variant="h3" style={{flex: 1, textAlign: 'center'}}>
          My Cart
        </CustomText>
      </View>
