...
const VenueReviewCard: FC<VenueReviewCardType> = ({
  createAt = new Date().toISOString(),
  name = 'John Doe',
  profilePic = 'https://i.pinimg.com/736x/2d/7a/c4/2d7ac424de1f7ca83011beb9f8b25b59.jpg',
  review = "​Yes, Google Cloud offers a $300 free credit as part of its 90-day Free Trial for new users. This means you have 90 days from the time you sign up to use up to $300 worth of Google Cloud services. The trial ends when either the 90 days have elapsed or you've spent the entire $300 credit, whichever comes first ​Yes, Google Cloud offers a $300 free credit as part of its 90-day Free Trial for new users. This means you have 90 days from the time you sign up to use up to $300 worth of Google Cloud services. The trial ends when either the 90 days have elapsed or you've spent the entire $300 credit, whichever comes first",
  star = 4,
}) => {
  return (
