...
const PracticeScreen = () => {
    ...
    const animatedStyle = useAnimatedStyle(() => ({
        transform: [{ translateY: direction.value === 1 ? withTiming(100) : withTiming(0) }]
    }))
                    ...
                    loader
                        ...
                        productData && productData.length == 0
                            ...
                            productData?.map((item) => (
                                <View key={item.id} style={{ backgroundColor: AppConstants.whiteColor, padding: AppConstants.screenPadding, marginVertical: s(10) }}>

                                    <CustomImage source={item.thumbnail} width={AppConstants.screenWidth - AppConstants.screenPadding * 4} height={AppConstants.screenWidth - AppConstants.screenPadding * 4} />
