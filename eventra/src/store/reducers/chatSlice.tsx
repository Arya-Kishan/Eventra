...
export const chatSlice = createSlice({
  ...
  reducers: {
    ...
    setSelectedOpponentUser: (state, action: PayloadAction<userType | null>) => {
      state.selectedOppoentUser = action.payload
    },
  },
})

export const { setUnSeenMessages, addUnOpendedMessages, setMessages, setSelectedOpponentUser, setUnOpendedMessages } = chatSlice.actions
