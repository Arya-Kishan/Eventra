...
const useNotification = () => {
    ...
    const addNotificationToStore = (remoteMessage: FirebaseMessagingTypes.RemoteMessage) => {

        const newNotification: NotificationType = {
            title: remoteMessage.notification?.title!,
            body: remoteMessage.notification?.body!,
            notification_type: remoteMessage.data?.notification_type as "like" | "comment" | "booking",
