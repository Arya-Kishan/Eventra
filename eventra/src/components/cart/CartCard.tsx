    ...
    <View style={styles.main}>
      ...
      <View style={styles.horizontal}>
        <View style={styles.spcBtn}>
          <CustomText
            variant="h6"
            numberOfLines={2}>{`${product.product?.title}`}</CustomText>
      ...
      <View style={styles.floatBtn}>
        <CustomText
          ...
          }}>{`${product.product!.discountPercentage.toString()}% off`}</CustomText>
      </View>
    </View>
  );
};
