...
const getAllorder = async (): Promise<ApiReturnType> => {
    try {
        ...
        return { data: null, message: "Error in orders Fetching", success: false, error: JSON.stringify(error) };  // Rethrow the error to be handled by the calling function
    }
};
...
const createorderApi = async (order: OrderType): Promise<ApiReturnType> => {
    ...
    try {
        ...
        return { data: null, message: "Error in orders creating", success: false, error: JSON.stringify(error) };  // Rethrow the error to be handled by the calling function
    }

}

const updateorderApi = async (order: FormData, id: string): Promise<ApiReturnType> => {
...
export { createorderApi, getAllorder, updateorderApi, getSingleorder, getUpcomingordersApi };
